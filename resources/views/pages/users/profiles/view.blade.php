...
@section('content')
                    ...
                    {!! Form::open(['action' => ['MyProfileController@myEdit'], 'method' => 'POST'])!!}
                        ...
                        <div class="col-md-3">
                          <div class="form-group ">
                            <label >Department/Unit :</label>
                              ...
                              <input type="text" class="form-control" name="department" value="{{$user->department_name}}" readonly>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <label >Manager :</label>
                              ...
                              <input type="text" class="form-control" name="manager" value="{{$user->manager_name}}" readonly>
